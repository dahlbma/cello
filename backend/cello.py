...
def make_app():
    return tornado.web.Application([
        ...
        (r"/uploadNetVials", application.UploadNetVials),
        ...
        (r"/createPlates/(?P<sPlateType>[^\/]+)/(?P<sSubType>[^\/]+)/(?P<sPlateName>[^\/]+)/(?P<sNumberOfPlates>[^\/]+)/(?P<sLocation>[^\/]+)/(?P<sDuplicate>[^\/]+)",
        ...
        (r"/getSMILESForElements/(?P<joinedIds>[^\/]+)", application.GetSMILESForElements),
